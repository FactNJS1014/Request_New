    ...
    <form @submit.prevent="submitRequest">
      ...
      <div class="grid grid-cols-2">
        <div class="flex flex-col">
          ...
          <input type="text" class="p-3 text-xl font-normal border-2"
        ...
        <div class="flex flex-col mt-2">
          ...
          <input type="number" class="p-3 text-xl font-normal border-2" placeholder="ระบุจำนวน..." min="0" max="100"
            v-model="form.qty">
        ...
        <div class="flex flex-col mt-2 ms-2">
          ...
          <input type="text" class="p-3 text-xl font-normal border-2" v-model="form.unit">
        ...
        <div class="flex flex-col mt-2">
          ...
          <input type="text" class="p-3 text-xl font-normal border-2" placeholder="กรอกหมายเหตุ..."
            v-model="form.remark">
        ...
        <div class="flex flex-col mt-2 ms-2">
          ...
          <input type="file" class="p-3 text-xl font-normal border-2" @change="handlefiles">

        </div>
      </div>

      <div class="flex justify-end mt-3">
        <button type="submit" class="px-4 py-3 text-xl font-semibold text-white bg-blue-500 rounded-lg">เพิ่มรายการ</button>
      </div>
